...
module XIVAPI
  module Structs
    # Struct containing minimal data about a Character.
    # This struct is used during Character searches, as well as used to represent Character's in another Character's Friend List or Free Company Member List.
