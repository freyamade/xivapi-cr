...
module XIVAPI
  module Structs
    # Struct representing an item on the Market Board.
    struct MarketItem
      ...
      # An Array of `ItemHistory` structs representing the old sale values of the Item.
      getter history
      # The ID of the MarketItem.
      # The ID string is in the format of "#{server_id}_#{item_id}".
      getter id
      # An `Item` struct representing the item up for sale.
      getter item
      # The ID of the Item being sold.
      getter item_id
      # The ID of the Item on the Lodestone.
      getter lodestone_id
      # An Array of `MarketEntry` structs showing the current prices of the Item.
      getter prices
